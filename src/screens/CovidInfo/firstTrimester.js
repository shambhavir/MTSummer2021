    ...
    return (
        <View style={styles.container}>
            ...
            <Text    style={{
                ...
                fontWeight: "bold",
                fontStyle:"italic"
              }}>Expected symptoms during pregnancy?{'\n'}Physical and Hormonal:
              </Text>
              </FadeInView>
              <Text
              style={{
